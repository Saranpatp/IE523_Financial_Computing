...
double adjusted_prob(double stock_price) //lesson7 part 1.1
{
    double pc =
...
vector<double> Monte_Carlo() //montecarlo simulation with 4 path for price of 1 path
{
    ...
    double tmp = adjusted_prob(current_stock_price1);
